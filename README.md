...
This is a python program that features a battleship game which involves two players, where each player has a grid representing an "ocean" on which they place "battleships" of various sizes. The location of each player's battleships are kept hidden from their opponent.
